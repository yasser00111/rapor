...
<head>
	...
	<title>Aplikasi Raport SMK 5 Barru</title>
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="<?php echo base_url(); ?>" class="simple-text">
                    <i class="pe-7s-study"></i> Raport SMK 5 Barru
                </a>
            </div>
            <ul class="nav">
                <?php 
                ...
                echo generate_menu($admlevel,$walikelas['is_wali'] ?? null);  
                ?>
            </ul>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><i class="pe-7s-study"></i> Raport SMK 5</a>
                </div>
