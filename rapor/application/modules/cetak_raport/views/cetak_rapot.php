...
<body>
	<table>
		...
		<tr>
			...
			<td width="20%">Kelas</td><td width="1%">:</td><td width="19%" class="tbl"><?php echo strtoupper($wali_kelas['nmkelas'] ?? 0); ?></td>
		</tr>
		<tr>
				...
				<table width="100%">
					<tr>
						...
						<td width="25%">
							...
							Wali Kelas <br>
							<br><br><br><br>
							<u><b><?php echo $wali_kelas['nmguru']?? 0; ?></b></u><br>
							NIP. <?php echo $wali_kelas['nip']?? 0; ?>
						</td>
						<td width="8%"></td>
						<td width="29%">
						    <?php 
