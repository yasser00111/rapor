...
<body>
	<table>
		<tr>
			<td width="10%">
			<img src="<?php echo base_url(); ?>aset/img/logosmk5.png" style="margin-top: 10px; width: 90px; height: 80px">
			</td>
			<td style="text-align: center"><b> DINAS PENDIDIKAN REPUBLIK INDONESIA<br>
			DINAS PENDIDIKAN KABUPATEN BARRU<br>
			...
			Telp :  0427-3230898 | Web : https://smkn5barru.sch.id/</span>
			</td>
		</tr>
		...
		<tr><td colspan="2">
			...
			<table width="100%">
				...
				<tr><td>12.</td><td>Ijazah SMP / Mts / Paket B</td><td>:</td><td></td></tr>
				<tr><td></td><td>a. Nomor</td><td>:</td><td><?php echo $ds['ijazah_no']; ?></td></tr>
				<tr><td></td><td>b. Tahun</td><td>:</td><td><?php echo $ds['ijazah_thn']; ?></td></tr>
				<tr><td>13.</td><td colspan="3">Surat Keterangan Hasil Ujian Akhir Sekolah Berstandar Nasional (UASBN) Smp / Mts / Paket B</td></tr>
	...
	<div style="margin-left: 120px; display: inline; float: left;">
		BARRU, <?php echo tjs($ds['diterima_tgl'],"l"); ?><br>
		Kepala sekolah<br>
		<br>
		<br>
		<br>
		<br>
		<b><u>Drs. Arifin</u></b><br>
		NIP. 12345678910
	</div>
