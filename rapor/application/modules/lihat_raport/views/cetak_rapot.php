...
<body>
	...
	<table>
		...
		<tr>
			<td width="20%">Nama Sekolah</td><td width="1%">:</td><td width="39%" class="tbl">SMK NEGRI 5 BARRU</td>
			<td width="20%">Kelas</td><td width="1%">:</td><td width="19%" class="tbl"><?php echo strtoupper($wali_kelas['nama_kelas']); ?></td>
		</tr>
		<tr>
			<td>Alamat Sekolah</td><td>:</td><td class="tbl">Lampoko, Lampoko, Balusu</td>
		...
		<tr><td colspan="6"><b>A. Pengetahuan dan Keterampilan</b></td></tr>
		<tr><td colspan="6">
			<table class="table">
				<thead>
				<tr>
		...
		<tr><td colspan="6"><b>B. Ekstrakurikuler</b></td></tr>
		<tr><td colspan="6">
			<table class="table">
				<thead>
					<tr>
			...
			<tr><td colspan="6"><b>C. Sikap</b></td></tr>
		<tr><td colspan="6">
					...
					<tr>
						<td width="40%">
							<table class="table" width="100%">
								<tr><td width="60%">Sakit</td><td width="40%" class="ctr"><?php echo $nilai_absensi['s'] ?? 0; ?> &nbsp; hari</td></tr>
								<tr><td>Izin</td><td class="ctr"><?php echo $nilai_absensi['i'] ?? 0; ?> &nbsp; hari</td></tr>
								<tr><td>Tanpa Keterangan</td><td class="ctr"><?php echo $nilai_absensi['a'] ?? 0; ?> &nbsp; hari</td></tr>
							</table>
						</td>
						<td width="60%">
						</td>
			...
			<td colspan="6">
				...
				<table width="100%">
					<tr>
						...
						<td width="10%"></td>
						<td width="30%">
							Lampoko, <?php echo $this->config->item('tgl_cetak'); ?><br>
							Kepala Smk Negri 5 Barru <br>
							<br><br><br><br>
							<u><b>Drs. Arifin</b></u><br>
