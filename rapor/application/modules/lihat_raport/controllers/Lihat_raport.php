...
class Lihat_raport extends CI_Controller {
    ...
    public function cetak($id_siswa,$tasm) {
        ...
        $q_get_kelas = $this->db->query("SELECT 
                                a.id_kelas, b.nama nmkelas, d.nama nmwalikelas, d.nip nipwalikelas
        ...
        $get_id_kelas =  $q_get_kelas['id_kelas'];
        // print_r();
        // exit();
        ...
        $so_pc_selalu = explode(",", $q_nilai_sikap_so['selalu'] ?? null);
        $so_mulai_meningkat = $q_nilai_sikap_so['mulai_meningkat'] ?? null;
        ...
        $kelompok = array("A", "B","C1","C2","C3","C1TITL","C2TITL","C3TITL","C1AP","C2AP","C3AP","C1GP","C2GP","C3GP","keahlian");
        ...
        //     $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = '$k'")->result_array();
            ...
            $d['nilai_utama'] .= '<tr><td colspan="8"><b>A. Muatan Nasional</b></td></tr>';
            $no = 0;
            ...
            if ($this->config->item('is_kemenag') == TRUE) {    
                // $d['nilai_utama'] .= '<tr><td class="ctr">'.$no.'</td><td colspan="8"></td></tr>';
                $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'A' AND tambahan_sub = ''")->result_array();
            ...
            //no pai kelompok B
            $d['nilai_utama'] .= '<tr><td colspan="8"><b>B. Muatan Kewilayahan</b></td></tr>';
            ...
            // $d['nilai_utama'] .= '<tr><td class="ctr">'.$no.'</td><td colspan="8"></td></tr>';
                $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'B' AND tambahan_sub = ''")->result_array();
            ...
            $d['nilai_utama'] .= '<tr><td colspan="8"><b>C. Muatan Keminatan Kejuruan</b></td></tr>';
            $d['nilai_utama'] .= '<tr><td colspan="8"><b> C1 Dasar Bidang Keahlian</b></td></tr>';
            ...
            // $d['nilai_utama'] .= '<tr><td class="ctr">'.$no.'</td><td colspan="8"></td></tr>';
                $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'C1' AND tambahan_sub = ''")->result_array();
            ...
            $d['nilai_utama'] .= '<tr><td colspan="8"><b> C2 Dasar-Dasar Program Keahlian</b></td></tr>';
            ...
            // $d['nilai_utama'] .= '<tr><td class="ctr">'.$no.'</td><td colspan="8">l</td></tr>';
                $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'C2' AND tambahan_sub = ''")->result_array();
            ...
            // $d['nilai_utama'] .= '<tr><td colspan="8"><b>Muatan asPeminatan Kejuruan</b></td></tr>';
            // $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'C3' AND tambahan_sub = 'NO'")->result_array();
            ...
            //                         </tr>';
            // }
            // kode Di atas Umum ditampilkan semua

            // Filter Keahlian
            $d['nilai_utama'] .= '<tr><td colspan="8"><b>C3 Kompetensi keahlian</b></td></tr>';
            $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'Keahlian' AND id_kelas=$get_id_kelas AND NULLIF(id_kelas, '') IS NOT NULL AND tambahan_sub = 'NO'")->result_array();
            ...
            // $d['nilai_utama'] .= '<tr><td class="ctr">'.$no.'</td><td colspan="8"></td></tr>';
                $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'C3' AND tambahan_sub = ''")->result_array();
